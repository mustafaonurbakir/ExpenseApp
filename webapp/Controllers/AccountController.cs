    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(AccountLoginModel viewModel)
        {
            ...
            if (user != null)
            {
                ...
                HttpContext.Session["CurrentUserRole"] = UserHandler.GetUserRole(user.Id);
                HttpContext.Session["CurrentUserRoleId"] = UserHandler.GetUserRoleId(user.Id);
                HttpContext.Session["CurrentUserEmail"] = user.Email;
        ...
        public async Task<ActionResult> Register(AccountRegistrationModel viewModel)
        {
            ...
            try
            {
                ...
                //////account._manager.AddToRole(User.Identity, "Employee");
               return Redirect("~/");
            }
